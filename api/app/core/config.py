...
class Settings:
    ...
    MONGODB = os.getenv("MONGODB", "mongodb+srv://w444555888:w444555888@sofa.bktklk2.mongodb.net/BookingChallenge?retryWrites=true&w=majority&appName=sofa")
    # 從環境變數中取得 REDIS 的設定值，若未設定則使用預設值 "redis://localhost:6379/0"
